...
public class BongoAdapter extends ArrayAdapter <Bongo> {
    public BongoAdapter(BongoActivity bongoActivity, ArrayList <Bongo> bongoArrayList) {
        super(bongoActivity, 0, bongoArrayList);
    }
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        Bongo currentColor = getItem(position);
